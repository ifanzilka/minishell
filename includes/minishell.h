...
/*   Updated: 2021/04/13 15:48:50 by exenia           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					ft_add_history(t_shell *shell, const char *filename,
						char *str);
...
int					ft_unset_envp_export(char *str, char ***export,
						char ***envp);
int					ft_cd(char **argv, t_shell *shell);
int					ft_pwd(char **argv, char **envp);
int					ft_echo(char **argv, char **envp);
int					ft_exit(char **argv);
int					ft_command(char *comand, char **argv,
						t_shell *shell, long long int *fds);
void				ft_cmd_in_pipe(t_data *data, t_shell *shell);
int					ft_fork_and_execve_command(char *comand,
						char **argv, char **envp);
int					ft_dont_path(char *comand, char **argv, char **envp);
int					ft_with_path(char *csomand, char *path,
						char **argv, char **envp);
...
char				*redirection_parse(char *str,
						long long int **fds, t_shell *shell);
